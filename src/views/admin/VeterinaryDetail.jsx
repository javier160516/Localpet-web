  ...
  return (
    <div className='overflow-y-auto h-full'>
      <div className='w-8/12 bg-white shadow-md rounded-md mx-auto my-10 p-3 overflow-y-auto'>
        <h1 className='text-xl font-bold text-center my-4 uppercase'>Nombre de la veterinariaaaaa</h1>
        ...
        <div>
          <form className='w-10/12 mx-auto'>
            <div className='my-5 text-center'>
              ...
              <p className='bg-gray-100 rounded-md py-1'>879789767657565</p>
            </div>
            <div className='text-center'>
              <label className='font-bold'>Clase de Actividad</label>
              <p className='bg-gray-100 rounded-md py-1 px-2'>Ejemplo nombre de la veterinaria largooooooo</p>
            </div>
            ...
            <div className='flex flex-col my-2 md:my-4 md:py-3 justify-between md:flex-row gap-4 text-center'>
              <div className='flex-1'>
                ...
                <p className='bg-gray-100 rounded-md py-1 px-2'>Holaaaa</p>
              </div>
              <div className='flex-1'>
