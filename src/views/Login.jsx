...
<Header/>
      <div className='h-screen bg-slate-300 flex justify-center items-center'>
        {!token ? (
          ...
          <div className='w-11/12 sm:w-8/12 md:w-7/12 lg:w-4/12 bg-white shadow border rounded-xl px-10 ' >
            ...
            <form action="" method="post" className='py-5' onSubmit={handleSubmit}>
              ...
              <div className='mb-6'>
                <label htmlFor="password" className='block ml-2 mb-1 text-sm font-semibold'>Contraseña</label>
