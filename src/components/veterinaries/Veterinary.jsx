      ...
      <div className='w-11/12 mx-auto mt-3 md:mt-0 flex-1'>
        ...
        <div className='mt-4 lg:pr-4 flex flex-col lg:flex-row lg:justify-between lg:items-center'>
          ...
          <div className='mt-4 lg:mt-0 flex lg:flex-col justify-evenly'>
            <Link to={`edit/${id}`} type='button' className='flex flex-col lg:flex-row items-center justify-center bg-orange-500 hover:bg-orange-600 text-white py-2 px-3 rounded-lg transition-all duration-300 lg:mb-2'>
              <FontAwesomeIcon icon={faPencil} className='lg:mr-2' />
              Editar
            </Link>
            <button type='button' className='flex flex-col lg:flex-row items-center justify-center bg-red-600 hover:bg-red-700 text-white py-2 px-3 rounded-lg transition-all duration-300' onClick={() => deleteVeterinary(id)}>
