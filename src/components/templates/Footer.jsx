...
const Footer = () => {
  useEffect(() => {
    const localstorage = localStorage.getItem('localstorage');
      ...
      <div className='md:flex md:justify-center md:flex-wrap gap-5 w-10/12 mx-auto mb-4'>
        <div className='flex justify-center flex-1'>
          <ul className='w-10/12 flex flex-col justify-center text-white'>
            ...
            <Link to={'sobre-nosotros'} className='flex justify-center lg:justify-start hover:ml-3 transition-all duration-300 my-2'>
              <img src={points} loading='lazy' width={15} />
        ...
        <div className='flex justify-center flex-1'>holaa</div>
      </div>
