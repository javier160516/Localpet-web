      ...
      <div className='md:flex md:justify-center md:flex-wrap gap-5 w-10/12 mx-auto mb-4'>
        <div className='flex justify-center flex-1'>
          <ul className='w-10/12 flex flex-col justify-center text-white'>
            <NavLink to={'/'} className='flex justify-center lg:justify-start hover:ml-3 transition-all duration-300 my-2'>
              <img src={points} loading='lazy' width={15} />
              <p className='ml-2'>Inicio</p>
            </NavLink>
            <NavLink to={'/sobre-nosotros'} relative="path" className='flex justify-center lg:justify-start hover:ml-3 transition-all duration-300 my-2'>
              <img src={points} loading='lazy' width={15} />
              <p className='ml-2'>Nosotros</p>
            </NavLink>
            <NavLink to={'/buscar-veterinaria'} className='flex justify-center lg:justify-start hover:ml-3 transition-all duration-300 my-2'>
              <img src={points} loading='lazy' width={15} />
