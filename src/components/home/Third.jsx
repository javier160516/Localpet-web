        ...
        <div className='w-10/12 bg-slate-50 shadow-md rounded-md py-5 px-3 grid lg:grid-cols-2 items-center justify-items-center gap-5 lg:gap-0'>
            ...
            <div className='flex flex-col justify-center items-center w-10/12'>
                ...
                <div className='w-full flex justify-center my-3'>
                    <button className='text-center mt-4 text-lg border-orange-500 border-2 text-orange-500 py-1 px-6 hover:bg-orange-500 hover:text-white transition-all duration-400 rounded-xl'>Más sobre My Happy Pet </button>
                </div>
            </div>           
        </div>
    </div>
