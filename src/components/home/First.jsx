        ...
        <div className='flex flex-col gap-32 justify-between h-[92vh]'>
            <div className='w-11/12 mx-auto flex flex-col lg:flex-row items-center justify-items-center gap-7 mt-6'>
                ...
                <div className='flex flex-col justify-center items-center flex-1'>
                    ...
                    <NavLink to={'buscar-veterinaria'} className='transition-all duration-300 text-center mt-5 text-lg bg-orange-400 text-white py-1 px-4 hover:bg-orange-500 font-bold rounded-full mb-3'>Buscar ahora</NavLink>
                </div>
            </div>
